...
function solicitarJugador(){
    ...
    // Se utiliza la repetitiva do-while, para que la funcion genere iteraciones hasta que se ingrese un nombre el cual su primer caracter sea una letra
    do{
...
function ordenAlfabetico($partidasParaOrdenar) {   
    ...
    //La función ordenAlfabetico se encarga de llamar a la función uasort e imprimir con print_r
...
/** Carga la partida recién jugada al array (Historial de partidas)
...
/** Función para comprobar si el jugador ya jugo con una palabra
 * @param ARRAY $historialDePartidas
 * @param ARRAY $coleccion DePalabras (array indexado)
 * @param STRING $palabra
...
function noJugoAun($usuario){
    divisor();
    echo "El jugador ".$usuario." aún no ha jugado Wordix! No registra ninguna partida.\n";
    divisor();  
}
/** Función sin parámetros que solo detiene la ejecucion del programa para que el usuario vea los datos presentados en pantalla.
*/
function pausa(){
// STRING $pausa
...
/*********** PROGRAMA PRINCIPAL *******/
/**************************************/
/* Wordix es un Juego de palabras muy adictivo en el que tendrás que adivinar palabras. Tu tarea consiste en adivinar una palabra de cinco letras en seis intentos. */
...
do {
    ...
    switch ($opcion) {  //la función switch reemplaza al condicional if-elseif, no compara, si no que tiene una opción para cada caso, en caso de no haber COINCIDENCIA para el valor ingresado, el apartado "default" determina que hacer.
        case 1: 
            ...
            $jugo = repitePalabra($historialPartidas,$coleccionPalabras,$numeroPalabra,$nombreUsuario);         
                if ($jugo == true){
                    echo "Esa palabra ya fue jugada, ingrese un número distinto.\n";
                }
            }while($jugo != null);
        ...
        case 2:
            ...
            echo "Se eligio aleatoreamente la palabra número: ".($numeroPalabra+1)."\n";
            $partidaNueva = jugarWordix($coleccionPalabras[$numeroPalabra],$nombreUsuario);
            $historialPartidas = agregarPartida($historialPartidas,$partidaNueva);
            pausa(); 
            break;
        case 3: 
            ...
            echo "Indique número de partida a visualizar: ";
        ...
        case 4: 
            ...
            //...
        case 5:
            // 5) Mostrar resumen de Jugador, pide nombre del jugador y llama una función que consulta al historial de partidas devolviendo un array asosiativo ordenado en el formato solicitado, con los datos del jugador.
            $nombreUsuario = solicitarJugador();
        ...
        default:
            ...
            echo "ERROR!!! Ingrese una opción correcta: \n";
            break;
    }
} while ($opcion != 8);
